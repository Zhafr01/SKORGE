...
export function JobRoleCard({ role, href }: JobRoleCardProps) {
    ...
    return (
        <Link 
            to={href}
            className="group flex flex-col border border-white/60 dark:border-white/5 rounded-[2rem] p-8 transition-all duration-700 hover:border-sky-400/50 hover:shadow-[0_20px_50px_rgba(14,165,233,0.2)] hover:-translate-y-3 relative overflow-hidden h-full min-h-[300px]"
        >
            ...
            <div className="absolute inset-0 z-0 bg-white/60 dark:bg-[#0B1120]/80 backdrop-blur-2xl">
                <div className="absolute -top-20 -right-20 w-64 h-64 bg-gradient-to-br from-sky-400/30 to-purple-500/30 rounded-full blur-[50px] group-hover:scale-150 group-hover:from-sky-400/50 transition-all duration-1000"></div>
            ...
            <div className="flex items-start justify-between mb-8 relative z-10">
                <div className="w-16 h-16 rounded-[1.25rem] bg-gradient-to-br from-white to-slate-50 dark:from-sky-500/20 dark:to-purple-500/20 border border-white dark:border-white/10 flex items-center justify-center text-sky-500 dark:text-sky-300 shrink-0 group-hover:scale-110 group-hover:-rotate-6 transition-all duration-500 shadow-xl shadow-sky-500/10">
            ...
            <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-3 tracking-tight group-hover:text-sky-600 dark:group-hover:text-sky-300 transition-colors duration-300 relative z-10 drop-shadow-sm">
                {role.name}
            </h3>
            ...
            <div className="grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-all duration-500 ease-in-out opacity-0 group-hover:opacity-100 mb-2 relative z-10">
                <div className="overflow-hidden flex flex-col gap-2">
                    <div className="flex items-center gap-2 text-xs text-sky-800 dark:text-sky-200 font-bold bg-white/50 dark:bg-white/10 backdrop-blur border border-white/50 dark:border-white/20 p-3 rounded-2xl shadow-sm">
            ...
            {/* Bottom Metrics */}
            <div className="flex items-center justify-between mt-auto pt-6 border-t border-slate-200/50 dark:border-white/10 group-hover:border-sky-500/40 transition-colors relative z-10">
                <div className="flex items-center gap-5">
                    <div className="flex items-center gap-2 text-slate-700 dark:text-slate-200">
                        <BookOpen className="w-5 h-5 text-sky-500 drop-shadow-sm" />
