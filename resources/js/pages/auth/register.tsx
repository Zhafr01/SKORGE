...
export default function Register() {
    ...
    return (
        <div className="min-h-screen flex w-full bg-white dark:bg-slate-950 relative overflow-hidden transition-colors duration-300">
            ...
            <div className="hidden lg:flex w-1/2 relative items-center justify-center p-12 bg-white dark:bg-slate-950 overflow-hidden order-last transition-colors duration-300">
                {/* Decorative blobs */}
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-24 relative z-10 bg-white dark:bg-slate-950 transition-colors duration-300">
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-8">
                        <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white mb-2 transition-colors duration-300">Create an account</h1>
                        <p className="text-slate-500 dark:text-slate-400 transition-colors duration-300">Join thousands dominating their career paths</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            {errors.name && <p className="text-rose-500 dark:text-rose-400 text-xs mt-1.5 font-medium pl-1 transition-colors duration-300">{errors.name}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.email && <p className="text-rose-500 dark:text-rose-400 text-xs mt-1.5 font-medium pl-1 transition-colors duration-300">{errors.email}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.password && <p className="text-rose-500 dark:text-rose-400 text-xs mt-1.5 font-medium pl-1 transition-colors duration-300">{errors.password}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.passwordConfirmation && <p className="text-rose-500 dark:text-rose-400 text-xs mt-1.5 font-medium pl-1 transition-colors duration-300">{errors.passwordConfirmation}</p>}
                        </div>

                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-3.5 flex items-center justify-center gap-2 rounded-xl bg-cyan-600 hover:bg-cyan-500 dark:bg-cyan-600 dark:hover:bg-cyan-500 disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold text-lg transition-all hover:scale-[1.02] hover:shadow-lg hover:shadow-cyan-500/30 mt-4 custom-ring"
                        >
                            {isLoading ? (
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-slate-500 dark:text-slate-400 text-sm transition-colors duration-300">
                            ...
                            <Link to="/login" className="text-cyan-600 dark:text-cyan-400 font-bold hover:text-cyan-500 dark:hover:text-cyan-300 transition-colors duration-300">
                                Sign in
                            </Link>
                        </p>
                    </div>
                    ...
                    <div className="mt-8 relative border-slate-200 dark:border-slate-800">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-white dark:bg-slate-950 text-slate-400 dark:text-slate-500 transition-colors duration-300">Or sign up with</span>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 text-center text-xs text-slate-400 dark:text-slate-500 transition-colors duration-300">
