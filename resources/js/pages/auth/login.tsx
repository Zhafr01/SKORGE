            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-24 relative z-10 bg-white dark:bg-slate-950 transition-colors duration-300">
                <div className="w-full max-w-md">
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-4">
                        <button
                            onClick={() => window.location.href = `${import.meta.env.VITE_APP_URL ?? 'http://localhost:8000'}/api/auth/google/redirect`}
                            className="flex items-center justify-center py-2.5 px-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors duration-300 gap-2"
                        >
